    ...
    return (
        <div className=' rounded-2xl'>
            ...
            >
                ...
                <SwiperSlide>
                    <div className='bg-[url(https://plus.unsplash.com/premium_photo-1681825268400-c561bd47d586?q=80&w=2072&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)] h-[350px] lg:h-[500px] lg:bg-no-repeat bg-cover rounded-2xl flex justify-center items-center '>
